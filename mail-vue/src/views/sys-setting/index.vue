            ...
            <div class="card-content">
              <div class="concerning-item">
                ...
                <el-badge is-dot :hidden="!hasUpdate">
                  <el-button @click="jump('https://github.com/Mr-lanan/cloudmail-monet/releases')">
                    {{ currentVersion }}
                    <template #icon>
...
import ProviderSetting from "@/components/provider-setting/index.vue";
...
function getUpdate() {
  ...
  axios.get('https://api.github.com/repos/Mr-lanan/cloudmail-monet/releases/latest').then(({data}) => {
...
function backupSetting() {
  ...
  delete settingForm.mailProviders
  delete settingForm.providerPriority
